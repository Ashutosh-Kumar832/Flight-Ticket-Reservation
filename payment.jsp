...
<br>
	<div class="main">
								...
								<div class="pay-tabs">
									<h2>Select Payment Method</h2>
									  <ul class="resp-tabs-list">
										  ...
										  <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><label class="pic2"></label>Debit Card</span></li>
										  <div class="clear"></div>
									  </ul>	
								</div>
		...
		<p class="footer">If this page doesn't get redirected to book ticket page then <a href="booking.jsp">Click Here</a></p>
	</div>
</body>
</html>